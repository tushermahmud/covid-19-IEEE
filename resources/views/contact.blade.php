            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="doctor_box type_two ">
                            <div class="image_box ">
                                <img src="{{asset('frontend/assets/image/96376957_238851484124243_3260712757074329600_n.jpg')}}" class="img-fluid " alt="best-doctors " />
                                <div class="overlay ">
                                    <ul>
                                        <li><a href="https://www.facebook.com/bornilaboishakhi "><i class="fa fa-facebook "></i></a></li>
                                        <li><a href="mailto:farihatahosin@gmaill.com"><i class="fa fa-google "></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="content_box ">
                                <a href="# " class="contact_doctor "><span class="fa fa-phone "></span>+8801521333203</a>
                                <div class="text_box ">
                                    <h2> <a href="# ">Fariha Tahosin Boishakhi
                                        </a> </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="doctor_box type_two ">
                            <div class="image_box ">
                                <img src="{{asset('frontend/assets/image/96277529_761579911044955_6181745845017247744_n.jpg')}}" class="img-fluid " alt="best-doctors " />
                                <div class="overlay ">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook "></i></a></li>
                                        <li><a href="mailto:csponkoj@gmail.com"><i class="fa fa-google "></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="content_box ">
                                <a href="# " class="contact_doctor "><span class="fa fa-phone "></span>+8801533473694</a>
                                <div class="text_box ">
                                    <h2> <a href="# ">Ponkoj Chandra Shill
                                        </a> </h2>
                                </div>
                            </div>
                        </div>
